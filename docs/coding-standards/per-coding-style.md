...
> PHP Evolving Recommendation - 现代 PHP 代码风格规范
...
- [规则速查表](#规则速查表-quick-reference)
- [与 PSR-12 的主要区别](#与-psr-12-的主要区别)
- [核心规则总结](#核心规则总结)
- [常见错误示例](#常见错误示例-common-mistakes)
- [代码示例](#代码示例)
- [工具支持](#工具支持)
- [完整中文翻译](#完整中文翻译)
- [相关资源](#相关资源)
...
[PER Coding Style 中文完整版](../translates/chinese/per-coding-style/index.md)
