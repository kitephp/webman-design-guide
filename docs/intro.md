...
- **电商/订单系统** → [电商系统](examples/e-commerce.md)
- **内容发布** → [CMS](examples/cms.md)
- **管理后台** → [后台管理系统](examples/admin-dashboard.md)
- **SaaS 产品** → [多租户 SaaS](examples/multi-tenant-saas.md)
- **纯 API** → [RESTful API](examples/restful-api.md)
- **实时通讯** → [即时通讯系统](examples/im-chat.md)
- **工单流程** → [工单客服系统](examples/ticketing-system.md)
- **支付集成** → [支付网关集成](examples/payment-gateway.md)
- **数据分析** → [数据报表系统](examples/analytics-reporting.md)
- **服务拆分** → [微服务示例](examples/microservices.md)
